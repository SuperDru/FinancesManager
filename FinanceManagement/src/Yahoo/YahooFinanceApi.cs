...
namespace FinanceManagement.Yahoo
{
    public class YahooFinanceApi
    {
        ...
        public YahooFinanceApi(IOptions<YahooOptions> yahooOptions)
        {
            var options = yahooOptions?.Value ?? throw new ArgumentException("Options cannot be null", nameof(yahooOptions));
